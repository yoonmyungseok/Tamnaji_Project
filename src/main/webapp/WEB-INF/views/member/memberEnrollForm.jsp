    ...
    <div class="login-page">
      <div class="form">
        <form class="register-form" action="insert.me" method="post">
          ...
          <button type="button" class="mail-Check-Btn" id="confirm">인증</button>
          </div><br>
	      ...
	      <button type="button" class="name-Check-Btn" id="confirm">확인</button>
	      </div><br>
        ...
        <form class="find-form">
          ...
          <button id="pw-rset-btn">비밀번호 재설정</button>
