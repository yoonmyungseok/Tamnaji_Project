...
<body>
    ...
    <div class="content-board" id="content">
        <div style="padding-top: 70px; padding-bottom: 200px; margin: 0 auto;">
            <form action="update.bo" method="post" style="margin: 0 auto; width: 730px;" enctype="multipart/form-data">
                ...
                <fieldset>
                    <table style=" padding-left: 35px; padding-top: 20px;">
                        <tr>
                            <td><b>제목</b></td>
                            <td>
                                <input type="text" name="boardTitle" id="title" value="${ b.boardTitle }" required>
                            </td>
                        </tr>
                        <tr>
                            <td><b>내용</b></td>
                            <td>
                                <textarea name="boardContent" id="content-text" cols="52" rows="12" required>${ b.boardContent }</textarea>
                        	</td>
                        </tr>
                        <tr>
							<td><b>첨부파일</b></td>
								...
								<c:choose>
									<c:when test="${ empty ba.originName }">
										<div class="file-upload preview-image">
		                                    <input type="text" class="upload-name" value="첨부파일이 없습니다." disabled="disabled">
		                                    <label for="input-file">업로드</label>
		                                    <input type="file" id="input-file" class="upload-hidden" name="reupfile">
		                                </div>
									</c:when>
									<c:otherwise>
										<div class="file-upload preview-image">
		                                    <input type="text" class="upload-name" value="${ ba.originName }" disabled="disabled">
		                                    <label for="input-file">업로드</label>
		                                    <input type="file" id="input-file" class="upload-hidden" value="${ ba.originName }" name="reupfile">
		                                </div>
									</c:otherwise>
								</c:choose>
							</td>
                        ...
                        <tr>
                            <td><input type="submit" value="수정하기" id="submit"></td>
                            <td><input id="c-write-button-3" value="이전으로" onclick="javascript:history.go(-1);"></td>
                        </tr>
                    </table>
                    <br>
                </fieldset>
