...
<body>
  ...
  <jsp:include page="../common/header.jsp" />
	...
	<div class="wrapper">
	   ...
	   <div class="container">
		<p class="thanks" >
			<img src="https://opgg-com-image.akamaized.net/attach/images/20200722224328.1219608.gif" style="opacity: 0.4;">
		</p>
		<p class="thanks">
			<c:choose> 
				<c:when test="${empty loginUser}">
					<a class="mbti-color-g"></a>
				</c:when>
				<c:otherwise>
					<a class="mbti-color-g">${loginUser.nickname}</a>님에게
				</c:otherwise>
			</c:choose>
			<br>
			딱 맞는 제주도 공간, <br>
			<a class="mbti-color-o">탐나</a><a class="mbti-color-g">지</a>가 찾아드릴게요! 😎 <br>
			<span>아직 mbti를 모르신다면? <a href="https://www.16personalities.com/ko/%EB%AC%B4%EB%A3%8C-%EC%84%B1%EA%B2%A9-%EC%9C%A0%ED%98%95-%EA%B2%80%EC%82%AC" style="color: #282928; font-weight: 900;" target="_blank">여기를 클릭</a></span><br>
		</p>
			<form action="mbtilist.sp" method="">
				<span>
				<input type="text" id="mbti-input" name="mbti" placeholder="영문 4글자 입력" style="z-index: 999;"></span>
				<br>
				<button id="mbti-btn" class="cta">결과 확인하기</button>
			</form>
