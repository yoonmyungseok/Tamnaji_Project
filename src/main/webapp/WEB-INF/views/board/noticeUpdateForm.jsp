...
<body>
    ...
    <div class="content-notice" id="content">
        <div style="padding-top: 70px; padding-bottom: 200px; margin: 0 auto;">
            <form action="update.no" style="margin: 0 auto; width: 730px;">
                ...
                <fieldset>
                    <table style=" padding-left: 35px; padding-top: 20px;">
                        ...
                        <tr>
                            <td><b>내용</b></td>
                            <td>
                                <textarea name="noticeContent" id="content-text" cols="52" rows="12" required>${n.noticeContent}</textarea>
                        	</td>
                        </tr>
                        <tr>
                            <td><input type="submit" value="수정하기" id="submit"></td>
                            <td><input value="이전으로" id="previous-button" onclick="javascript:history.go(-1);"></td>
                        </tr>
                    </table>
                    <br>
                </fieldset>
