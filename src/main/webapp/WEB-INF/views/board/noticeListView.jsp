...
<div class="container" style=" padding-top: 170px;margin: 0 auto;">
  ...
  <div class="content-2" id="content" style=" height:1300px;">
    <p style="margin-top: 10px; margin-bottom: 40px; font-size: 25px;">공지사항</p>
    
    <c:if test="${loginUser.nickname eq '관리자'}">
	  <div>
		<button id="write-button" onclick="location.href='enrollForm.no'">작성하기</button>
	  </div>
    </c:if>
			...
			<div class="faq accordion">
			  <div class="question-wrapper">
				<div class="d-flex align-items-center">
				  <p class="question" title="">${n.noticeTitle}</p>
				</div><i class="material-icons drop">expand_more</i>
			  </div>
			  <div class="answer-wrapper">
				<p class="answer">${n.noticeContent}</p>
				  <div>
					<c:if test="${loginUser.nickname eq '관리자'}">
					  <button type="button" id="correction-button" onclick="location.href='updateForm.no?nno=${n.noticeNo}';">수정하기</button>
					  <button type="button" id="delete-button" onclick="location.href='delete.no?nno=${n.noticeNo}';">삭제하기</button>
					</c:if>
				  </div>
			  </div>
			</div>
